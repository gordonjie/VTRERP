...
namespace JN.K3.YDL.App.ServicePlugIn.MFG.InspectBill
{
    ...
    public class UnAudit: AbstractOperationServicePlugIn
    {
        public override void OnPreparePropertys(Kingdee.BOS.Core.DynamicForm.PlugIn.Args.PreparePropertysEventArgs e)
        {
            ...
            e.FieldKeys.Add("FSrcBillNo0");
            e.FieldKeys.Add("FSrcEntryId0");
        ...
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            foreach (var dataEntity in e.DataEntitys)
            {
                ...
                {
                    if (Convert.ToString(itemObj["SrcBillType"]).EqualsIgnoreCase("PUR_ReceiveBill"))
                    {
            ...
            if (lstEntryIds.Count > 0)
            {
                ...
                sbSql.AppendLine(" UPDATE T_PUR_ReceiveEntry AS T0 SET (FJNUNITENZYMES,FEXTAUXUNITQTY)=");
                sbSql.AppendLine(" (SELECT T3.F_JN_BASEUNITENZYMES,T3.F_JN_BASEUNITENZYMES*T1.FACTRECEIVEQTY ");
                sbSql.AppendLine(" FROM T_PUR_ReceiveEntry T1");
